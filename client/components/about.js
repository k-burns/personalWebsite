      ...
      <div className="background">
        ...
        <div>
          ...
          <p>
            ...
            again and to create simple apps with them in my free time. The
            family I was nannying for moved and it felt like the perfect time
            for a new start to pursue software engineering. I attended the Grace
            Hopper program and Fullstack Academy. Since then I have been working
            on personal projects, studying algorithms, and looking for a team to
